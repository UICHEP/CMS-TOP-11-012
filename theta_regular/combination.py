...
def build_model(type, mcstat = True):
    ...
    if type == 'narrow_lowmass':
        ...
        modelsemilow = build_semilow_model(
            ['low_mass_semileptonic_selection_rebinned.root'],
            narrow_low_mass,
            'zp*',
            mcstat
        )
        modeldilow = build_dilow_model(
            ['narrow_low_mass_dilepton_selection_rebinned.root'],
            narrow_low_mass,
            'zp*',
            mcstat
        )
        ...
        modelallhigh = build_hadhigh_model(
            ['high_mass_allhadronic_selection_rebinned.root'],
            narrow_high_mass,
            'zp*',
            mcstat
        )
        ...
        modeldilow = build_dilow_model(
            ['wide_low_mass_dilepton_selection_rebinned.root'],
            wide_low_mass,
            'zp*',
            mcstat
        )
