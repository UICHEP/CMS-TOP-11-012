...
binFile('narrow_low_mass_dilepton_selection.root', 'BNN output', ['ttbar', 'DY', 'VV', 'wjets', 'singletop', 'qcd'])
binFile('wide_low_mass_dilepton_selection.root', 'BNN output', ['ttbar', 'DY', 'VV', 'wjets', 'singletop', 'qcd'])
binFile('low_mass_semileptonic_selection.root', 'M_{t#bar{t}} [GeV/c^{2}]', ['ttbar', 'wlight', 'wc', 'wb', 'zlight', 'zc', 'zb', 'qcd', 'singletop'])
